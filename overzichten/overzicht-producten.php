        ...
        while ($row = mysqli_fetch_array($connect)) {
            ...
            <div class="col-3">
                <div class="thumb-wrapper">
                    <div class="img-box">
                        <img class="productIMG" src="../assets/images/<?php echo $row['productafbeelding']; ?>"
                             alt="Product">
                    </div>
                    <div class="thumb-content">
                        <h4><?php echo $row['naam']; ?></h4>
                        <p class="item-price"><span>Huidige bod: € <?php echo $row['minimumbod']; ?><br>
            </span><span><i class="fas fa-clock" style="margin-right: 5px;"></i><?php echo $row['einddatum']; ?></span>
                        </p>
